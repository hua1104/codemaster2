  ...
  await examFormRef.value.validate(async (valid) => {
    if (valid) {
      ...
      try {
        ...
        // 将 "YYYY-MM-DD HH:mm:ss" 转成 LocalDateTime 可解析的 "YYYY-MM-DDTHH:mm:ss"
